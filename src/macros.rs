...
macro_rules! json_internal {
    ...
    (null) => {
        $crate::ValueNoObjOrArr::Null
    };

    (true) => {
        $crate::ValueNoObjOrArr::Bool(true)
    };

    (false) => {
        $crate::ValueNoObjOrArr::Bool(false)
    };

    ([]) => {
        $crate::ValueNoObjOrArr::Array($crate::__private::vec![])
    };

    ([ $($tt:tt)+ ]) => {
        $crate::ValueNoObjOrArr::Array($crate::json_internal!(@array [] $($tt)+))
    };

    ({}) => {
        $crate::ValueNoObjOrArr::Object($crate::Map::new())
    };

    ({ $($tt:tt)+ }) => {
        $crate::ValueNoObjOrArr::Object({
